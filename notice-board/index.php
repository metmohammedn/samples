...
// Using the __DIR__ magic constant makes the path relative to the current file.
// This is a robust way to ensure the script can always find its data file.
define('DUTIES_FILE_PATH', __DIR__ . '/data/EDEntryV2.txt');
